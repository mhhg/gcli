...
class AvatarCell extends GridCell {
  constructor(props) {
    ...
    console.log('[AvatarCell] imageSrc:', imageSrc, 'props.imageId:', props.dataItem.imageId, 'ServerAddr:', Server.Addr);
  ...
  render() {
    return (<td style={{ padding: '2px' }}>
      <img style={{ height: '71px', width: '71px' }} src={this.state.imageSrc} />
    </td>);
  }
}
