...
class Provider extends React.Component {
  ...
  onDialogInputChange(event) {
    ...
    edited[name] = value;
    console.log(
      "[Providers.onDialogInputChange] edited:",
      edited,
      "name:",
      name,
      "value:",
  ...
  updateOwnerState(key, value) {
    ...
    console.log(
      "[Provider.updateOwnershipState] after update this.state.objectSearchState:",
      this.state.filter
    );
    Socket.emit(
      "provider:read",
    ...
    const grid = (
      ...
      >
        ...
        <Column
          ...
          width="160px"
        />
        <Column field="id" title="ID" width="20px" />
      </Grid>
    );
    const dialog = this.state.docInEdit && (
      ...
      >
        <form className="row k-form" onSubmit={this.handleSubmit}>
          ...
          <div style={{ marginBottom: "1rem" }} className="col-md-6">
            <label>
              ...
              <Input
                ...
                type="text"
                name="categories"
                value={this.state.docInEdit.categories || ""}
                onChange={this.onDialogInputChange}
              />
            </label>
          </div>
          <div style={{ marginBottom: "1rem" }} className="col-md-6">
            <label>
              ...
              <Input
                ...
                type="text"
                name="phoneNumbers"
                value={this.state.docInEdit.phoneNumbers || ""}
                onChange={this.onDialogInputChange}
              />
            </label>
          </div>
          ...
          <div style={{ marginBottom: "1rem" }} className="col-md-6">
            <label>
              ...
              <Input
                ...
                type="text"
                name="background"
                value={this.state.docInEdit.background || ""}
                onChange={this.onDialogInputChange}
              />
            </label>
          </div>
          ...
          <div
            className="col-md-6 k-form-field"
          ...
          <div style={{ marginBottom: "1rem" }} className="col-md-6">
            ...
            <Editor
              name="description"
              value={this.state.docInEdit.description || ""}
              change={this.onDialogInputChange}
              tools={[
                "bold",
                "italic",
                "underline",
          ...
          <div style={{ marginBottom: "1rem" }} className="col-md-6">
            ...
            <Editor
              name="advertisement"
              value={this.state.docInEdit.advertisement || ""}
              change={this.onDialogInputChange}
              tools={[
                "bold",
                "italic",
