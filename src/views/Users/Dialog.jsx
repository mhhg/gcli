  ...
  render() {
    return (
      <div className="k-dialog-wrapper">
        ...
        <div className="k-widget k-window k-dialog col-md-10">
          <div className="k-window-titlebar k-dialog-titlebar k-header">
            <div className="k-window-title k-dialog-title">
              {this.props.title}
            </div>
            <div className="k-window-actions k-dialog-actions">
              <a aria-label="Close" className="k-button k-bare k-button-icon k-window-action k-dialog-action k-dialog-close"
                onClick={() => this.props.close()} role="button">
