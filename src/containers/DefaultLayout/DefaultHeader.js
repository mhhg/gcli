...
class DefaultHeader extends Component {
  render() {
    ...
    return (<React.Fragment>
      ...
      <AppNavbarBrand full={{ src: logo, width: 154, height: 27, alt: "Reglazh Logo" }}
        minimized={{ src: golang, width: 30, height: 30, alt: "Reglazh Logo" }} />
      <AppSidebarToggler className="d-md-down-none" display="lg" />
      <Nav className="d-md-down-none" navbar>
        {/* <NavItem className="px-3"><NavLink href="#/provider">Dashboard</NavLink></NavItem> */}
        <NavItem className="px-3"><NavLink href="#/user">Users</NavLink></NavItem>
        <NavItem className="px-3"><NavLink href="#/provider">Provider</NavLink></NavItem>
      </Nav>
      <Nav className="ml-auto" navbar>
        <NavItem className="d-md-down-none"><NavLink href="#"><i className="icon-bell" /><Badge pill color="danger">5</Badge></NavLink></NavItem>
        <NavItem className="d-md-down-none"><NavLink href="#"><i className="icon-list" /></NavLink></NavItem>
        <NavItem className="d-md-down-none"><NavLink href="#"><i className="icon-location-pin" /></NavLink></NavItem>
